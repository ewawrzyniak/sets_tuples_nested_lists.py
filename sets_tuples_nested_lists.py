...
# print(tuple4.count(6)) #output0

# #find the index of an element in a tuple
# print(tuple3.index(3)) #output 2
...
# small_v=int(text_tuple.count('v'))
# large_V=int(text_tuple.count('V'))
# total_v=small_v + large_V
# # Output the result
# print(f"The passage has {small_v} lowecase v's and {large_V} uppercase V's, for a total of {total_v} v's. ")
...
# #list inside a list, pink brackets- 0-1, each value in pink brackets = 0-1
...
print(data["prices"]["pineapple"]) #output-privce of pineapple
